...
const CONFIG = {
  ...
  DRIVER_ACCEPTED:        { label: "Chauffeur accepté",    bg: "bg-teal-100",    text: "text-teal-700",    dot: "bg-teal-500"    },
  DRIVER_REJECTED:        { label: "Chauffeur refusé",     bg: "bg-orange-100",  text: "text-orange-700",  dot: "bg-orange-500"  },
  ...
  WAITING_AT_DESTINATION: { label: "Attente sur place",    bg: "bg-cyan-100",    text: "text-cyan-700",    dot: "bg-cyan-500"    },
  RETURN_TO_BASE:         { label: "Retour base",           bg: "bg-indigo-100",  text: "text-indigo-700",  dot: "bg-indigo-500"  },
  COMPLETED:              { label: "Terminé",              bg: "bg-green-100",   text: "text-green-700",   dot: "bg-green-500"   },
  BILLING_PENDING:        { label: "Facturation en cours", bg: "bg-sky-100",     text: "text-sky-700",     dot: "bg-sky-500"     },
  BILLED:                 { label: "Facturé CPAM",         bg: "bg-emerald-100", text: "text-emerald-700", dot: "bg-emerald-500" },
  PAID:                   { label: "Payé",                 bg: "bg-green-100",   text: "text-green-800",   dot: "bg-green-600"   },
  ...
  FAILED:                 { label: "Échec",                bg: "bg-red-100",     text: "text-red-800",     dot: "bg-red-700"     },
};
